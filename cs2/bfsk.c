...
int data[2][8]= {0, 1000, 0, -1000, 0, 1000, 0, -1000,
...
{
for (j_D=0; j_D<8; j_D++) // 8 data_table bits
{
...
//demodulation starts
if (temp[1]==500) // Use this for FSK //checks the 2nd value in
//temp array and determines //if corresponding bit is 1 or 0
{
bit = 1;
}
